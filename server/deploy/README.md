...
- Upstreams: Kystverket, BarentsWatch, Digitraffic, aisstream.io. BarentsWatch credentials go in `/etc/aiscast.env` (`BARENTSWATCH_CLIENT_ID`, `BARENTSWATCH_CLIENT_SECRET`).
